...
const phrases = ['За твои приятные духи', 'За твои тёплые обьятия',
 'За твои бип-бип', 'За твои куси перед сном', 'За твою постоянную заботу',
  ...
  'За твой забавный смех', 'За твои нежные ручки', 'За твою честность', 'За твою уверенность',
  'За "О, ворона"', 'За твои комплименты', 'За твою маленькость', 'За твои мягкие щёчки']
