...
const phrases = ['За твои приятные духи', 'За твои тёплыё обьятия',
 'За твои бип-бип', 'За твои куси перед сном', 'За твою нужную помощь',
  'За твои милые глазки', 'За твой приятный голос', 'За то, что ты всегда рядом',
  'За твой забавный смех', 'За твои согревающие ручки']
...
function lovere(e) {
 ...
 document.getElementById("btn").value= "А за что ещё?";
...
result-btn.addEventListener("click", lovere)
